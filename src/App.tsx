  ...
  return (
    <div>
      <div className="wrapper overflow-hidden relative">
        <div className="absolute top-[8200px] md:top-[7000px] lg:top-[5600px] -left-[300px] md:-left-[148px] lg:-left-[148px]  w-[750px] h-[750px] bg-gradient-to-r opacity-30 rounded-full bg-blend-soft-light from-[#233B6E] to-[#86A6FF] blur-[100px]"></div>
